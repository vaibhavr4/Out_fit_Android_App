...
public class SportLocationActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(sport.toLowerCase().equals("cricket")||sport.toLowerCase().equals("soccer") ||
                sport.toLowerCase().equals("baseball") || sport.toLowerCase().equals("rugby")
        || sport.toLowerCase().equals("volleyball"))
        {
        ...
        else if(sport.toLowerCase().equals("tennis"))
        {
            searchString = "tennis court";
        }
        else if(sport.toLowerCase().equals("badminton"))
        {
            searchString = "badminton court";
        }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(this,
                ...
                Toast.makeText(SportLocationActivity.this, "Nearby grounds", Toast.LENGTH_LONG).show();
            }
        } else {
            buildGoogleApiClient();
            mMap.setMyLocationEnabled(true);
...
//        });
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyBUlB828WUhcRpV044dsyPChxOim-t2Gi0");
    ...
    public void onLocationChanged(Location location) {
        ...
        Toast.makeText(SportLocationActivity.this,"Your Current Location", Toast.LENGTH_LONG).show();
